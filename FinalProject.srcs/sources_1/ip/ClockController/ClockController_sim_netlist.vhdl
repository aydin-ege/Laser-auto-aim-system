...
-- Date        : Mon Dec 30 21:56:28 2019
-- Host        : Ege-PC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top ClockController -prefix
--               ClockController_ ClockController_sim_netlist.vhdl
-- Design      : ClockController
...
entity ClockController_ClockController_clk_wiz is
  port (
...
end ClockController_ClockController_clk_wiz;

architecture STRUCTURE of ClockController_ClockController_clk_wiz is
  signal clk_in1_ClockController : STD_LOGIC;
  signal clk_out1_ClockController : STD_LOGIC;
  signal clk_out1_ClockController_en_clk : STD_LOGIC;
  signal clk_out2_ClockController : STD_LOGIC;
  signal clk_out2_ClockController_en_clk : STD_LOGIC;
  signal clk_out3_ClockController : STD_LOGIC;
  signal clk_out3_ClockController_en_clk : STD_LOGIC;
  signal clkfbout_ClockController : STD_LOGIC;
  signal clkfbout_buf_ClockController : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_ClockController,
      O => clkfbout_buf_ClockController
    );
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out1_ClockController,
      O => clk_out1_ClockController_en_clk
    );
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out2_ClockController,
      O => clk_out2_ClockController_en_clk
    );
...
clkout3_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out3_ClockController,
      O => clk_out3_ClockController_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_ClockController,
      CLKFBOUT => clkfbout_ClockController,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_ClockController,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_ClockController,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_ClockController,
      CLKOUT1B => NLW_mmcm_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_ClockController,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_ClockController_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg1(0)
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_ClockController_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg2(0)
...
\seq_reg3_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out3_ClockController_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg3(0)
...
entity ClockController is
  ...
  attribute NotValidForBitStream of ClockController : entity is true;
end ClockController;

architecture STRUCTURE of ClockController is
begin
inst: entity work.ClockController_ClockController_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
